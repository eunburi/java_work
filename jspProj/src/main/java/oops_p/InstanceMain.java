...
class AAA{
	...
	//누가먼저 실행되느냐? 멤버변수 할당먼저 함 / int의 - > 기본값 0 줌 string->null /  =>그다음 대입
	//공간을 만ㄷ늘고 대입을 함
...
//	void meth_4(int ... a, int b) { // 처리안됨
//		System.out.println("meth_44 실행"+Arrays.toString(a));
//	}
	//void meth_444(int ...a, int ...b) {// 처리안됨
	//	System.out.println("meth_33 실행"+Arrays.toString(a)+","+b);
	//}
